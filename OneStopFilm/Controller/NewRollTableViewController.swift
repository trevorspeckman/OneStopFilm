...
class NewRollTableViewController: UITableViewController {
    ...
    let tableLabels = ["Roll Name", "Film Stock", "ASA", "Frame Count", "Camera", "Color"]
    ...
    override func viewDidLoad() {
        ...
        //Setup UItableView
        tableView.register(TextFieldTableViewCell.self, forCellReuseIdentifier: "reuseIdentifier")
